 ...
 // This function adds the record at a particular day and time in the diary 
 void addrecord( ) 
 ...
 { 
     ...
     // if the user wants to add data on the same day but different time then this is done here 
